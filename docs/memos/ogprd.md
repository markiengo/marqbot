...
MarqBot is a degree-planning tool for Marquette University students. Today it is business-first, but it also supports selected non-business paths such as the Data Science major. It tells you what courses to take next, tracks your progress toward graduation, checks whether you're eligible for a specific course, lets you save plan snapshots, and gives you a built-in way to send feedback or bug reports.
...
### Saved Plans
Students can save recommendation runs in the browser, reopen them later, overwrite an older version when they want to keep one canonical plan, compare alternatives without re-entering all of their course history, and export a print-friendly PDF with per-semester tables plus course, title, credits, prerequisite, and satisfy columns.
...
Primarily College of Business students at Marquette, plus the currently supported non-business path for Data Science. It supports 11 business majors (Finance, Accounting, AIM, Business Administration, Business Economics, Business Analytics, Human Resource Management, International Business, Information Systems, Marketing, Operations & Supply Chain Management), 7 business tracks (AIM CFA, AIM FinTech, AIM IB, Commercial Banking, Financial Planning, Business Leadership, Professional Selling), the Data Science major, 5 MCC Discovery themes, and 6 minors (Business Administration, Entrepreneurship, Human Resources, Information Systems, Marketing, Supply Chain Management).
