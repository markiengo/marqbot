...
export function SavePlanModal({
  ...
  return (
    <Modal open={open} onClose={onClose} title="Save Plan" size="planner-detail">
      <PlannerActionFrame>
        <form className="relative flex h-full flex-col" onSubmit={handleSubmit}>
          ...
          <div className="relative flex-1 overflow-y-auto px-8 py-5">
          ...
          <div className="relative shrink-0 border-t border-border-subtle bg-surface-card px-8 py-4">
