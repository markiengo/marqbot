...
- `scripts/compile_quips.py` compiles `data/quips.csv` → `frontend/src/lib/quipBank.generated.ts`. Re-run after editing quips: `python scripts/compile_quips.py`. The generated file is committed to git.
