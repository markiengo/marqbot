  ...
  return (
    <div className="planner-shell">
      <div className="planner-grid">
        {/* ── Top-left: Profile inputs + submit ── */}
        <div className="planner-quad planner-quad-tl">
          <InputSidebar onSubmit={fetchRecommendations} loading={loading} />
        </div>

        {/* ── Top-right: Progress + KPIs + Degree Summary ── */}
        ...
        {/* ── Bottom-left: Preferences + Can-Take ── */}
        ...
        <div className="planner-quad planner-quad-br">
          <div className="h-full overflow-y-auto pr-1">
            {error && (
              <div className="bg-bad-light rounded-xl p-4 text-sm text-bad mb-4">
                {error}
              </div>
            )}
              ...
              <div className="flex flex-col items-center justify-center h-full text-center px-4 py-12 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-ink-faint mt-1 max-w-sm">
                    ...
                    courses, then hit &ldquo;Get Recommendations&rdquo; to unlock
